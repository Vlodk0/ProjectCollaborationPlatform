...
namespace ProjectCollaborationPlatform.Data.Migrations
{
    ...
    [Migration("20240320162526_deletedIdColumnFromTeamDeveloperModel")]
    partial class deletedIdColumnFromTeamDeveloperModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectCollaborationPlatform.DAL.Data.Models.Task", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectCollaborationPlatform.DAL.Data.Models.Project", b =>
                {
                    b.HasOne("ProjectCollaborationPlatform.DAL.Data.Models.ProjectDetail", "ProjectDetail")
                        .WithOne("Project")
                        .HasForeignKey("ProjectCollaborationPlatform.DAL.Data.Models.Project", "ProjectDetailID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProjectCollaborationPlatform.DAL.Data.Models.Task", b =>
                {
                    b.HasOne("ProjectCollaborationPlatform.DAL.Data.Models.FunctionalityBlock", "FunctionalityBlock")
                        .WithMany("Tasks")
